...
*/
ONVIF_API void MD5Init (MD5_CTX *context)
{
...
context.
*/
ONVIF_API void MD5Update (MD5_CTX *context, unsigned char *input, unsigned int inputLen)
{
...
*/
ONVIF_API void MD5Final (unsigned char digest[16], MD5_CTX *context)
{
